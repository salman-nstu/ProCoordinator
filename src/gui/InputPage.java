...
public class InputPage extends JFrame {
    ...
    public InputPage() {
        ...
        addButton.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Task added successfully!", "Success",
        ...
        submitButton.addActionListener((ActionEvent e) -> {
            if (tasks.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please add at least one task!", "Error",
    ...
    private void saveTasksToFile() {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("output/project_data.txt"))) {
            for (Task task : tasks) {
                writer.write(
                        task.getName() + "," + task.getDuration() + "," + String.join(":", task.getDependencies()));
                writer.newLine();
            }
        } catch (IOException e) {
            e.printStackTrace();
